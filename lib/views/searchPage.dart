...
class _SearchPageState extends State<SearchPage> {
  ...
  void initState() {
    ...
    try {
      searchStuff(isService: true).then((value) => showSpinner.value = false);
    } catch (e) {
      showSpinner.value = false;
    }
    searchStuff(isService: false);
    super.initState();
  }
                                ...
                                if (filterMap['didApply']) {
                                  selectedFilters.value =
                                      (Map.from(filterMap['isService']
                                          ? {
                                              'price-minS':
                                                  filterMap['price-minS'],
                                              'price-maxS':
                                                  filterMap['price-maxS'],
                                            }
                                          : {
                                              'price-minP':
                                                  filterMap['price-minP'],
                                              'price-maxP':
                                                  filterMap['price-maxP'],
                                            })
