            ...
            if (snapD['hasConnection']) {
              if (snapD['ok'] == 4) {
                ...
                final ValueNotifier<String> levelChoosed =
                    ValueNotifier<String>(snapD['english-levels'][0]['name']);

                ///LANGUAGES
                final List<String> languagesList = [
                  for (var i = 0; i < snapD['langues-prestataires'].length; i++)
                    snapD['langues-prestataires'][i]['name'],
                ];
                final ValueNotifier<String> languageChoosed =
                    ValueNotifier<String>(widget.infos['freelancer-language']
                ...
                final ValueNotifier<String> locationChoosed = ValueNotifier<
                    String>(widget
                        .infos[
                ...
                final ValueNotifier<String> sexChoosed = ValueNotifier<String>(
                    widget.infos['sexe'] /* snapD['sexes'][0]['libelle'] */);

                ///TYPES
                final List<String> typesList = [
                  for (var i = 0; i < snapD['types-prestataires'].length; i++)
                    snapD['types-prestataires'][i]['name'],
                ];
                final ValueNotifier<String> typeChoosed = ValueNotifier<String>(
                    snapD['types-prestataires']
                        [(snapD['types-prestataires'].indexWhere(
                  (elt) =>
                      elt['id'].toString() == widget.infos['freelance-type'],
                ))]['name']
                        ...
                        Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              TextFormField(
                                initialValue: widget.infos['user-nicename'],
                              ),
                              SizedBox(height: 15),
                              Text(
                                'Email',
                              ...
                              ValueListenableBuilder<String>(
                                ...
                                builder: (BuildContext context, String value,
                                  ...
                                  return DropdownButton(
                                    value: value,
                                    isExpanded: true,
                                    items: locationsList.map((String items) {
                                      return DropdownMenuItem(
                                          value: items,
                                          child: Text(
                                            items,
